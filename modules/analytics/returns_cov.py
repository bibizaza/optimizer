# File: modules/analytics/returns_cov.py
...
def compute_performance_metrics(
    ...
    """
    Computes older/traditional performance metrics from a daily absolute 
    portfolio series, including:
      - Total Return
      - Annualized Return
    ...
    ann_rf = daily_rf * trading_days_per_year
    sharpe = 0.0
    if ann_vol > 1e-12:
        sharpe = (ann_return - ann_rf) / ann_vol

    running_max = series_abs.cummax()
    dd_series = (series_abs / running_max) - 1
